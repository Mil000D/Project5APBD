...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.Join(Depts,
                                             ...
                                             .GroupBy(group => group.dept.Dname)
        ...
        {
            int result = arr.GetNumberWithOddCount();
            //result=
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = Depts.GetDepartments(Emps);
            //result =
            return result;
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var result = emps.Where(mgr => emps.Any(emp => emp.Mgr == mgr))
                             .OrderBy(mgr => mgr.Ename)
                             .ThenByDescending(mgr => mgr.Salary);
            return result;
        }
        public static int GetNumberWithOddCount(this int[] arr)
        {
        ...
        public static IEnumerable<Dept> GetDepartments(this IEnumerable<Dept> depts, IEnumerable<Emp> emps)
        {
